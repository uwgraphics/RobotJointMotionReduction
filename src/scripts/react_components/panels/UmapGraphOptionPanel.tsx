                  ...
                  <AccordionItemPanel>
                    <div>
                      ...
                      <LabeledSlider
                        ...
                        max={10}
                        step={0.01}
                        value={currSelectedGraph?.minHDFoldDis()}
                      ...
                      <LabeledSlider
                        ...
                        max={1}
                        step={0.001}
                        value={currSelectedGraph?.max2DFoldDis()}
                        onMouseUp={this.props.robotSceneManager.getCurrUmapGraph()?.setMax2DFoldDis.bind(this.props.robotSceneManager.getCurrUmapGraph())}
                      />
                    </div>
                  </AccordionItemPanel>
                </AccordionItem>
