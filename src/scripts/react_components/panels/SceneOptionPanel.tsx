...
export class SceneOptionsPanel extends Component<scene_options_panel_props, scene_options_panel_state> {
  ...
  applyChangesToAll()
  {
    ...
    render() {
        ...
        const style1 = {marginLeft: "1rem"};
        const style2 = {marginLeft: "0.5rem"};
        const style3 = {marginBottom: "0.5rem"};
        const style4 = {display: "flex", gap: "0.5rem", marginBottom: "0.5rem", height:"1em", alignItems: "center"};
              ...
              <AccordionItem>
                ...
                <AccordionItemPanel>
                  <div className={"SceneViews"}>
                    <div>
                      <LabeledCheckBox
                        label="Apply Changes to All Scenes"
                    ...
                    <div>
                      ...
                      <div style={style4}>
                        ...
                        {/* <button onClick={this.toggleWorldFrame.bind(this)}>{robotScene.worldFrame()}</button> */}
                      </div>
                      <div style={style4}>
                        ...
                        {/* <button onClick={this.toggleCameraType.bind(this)}>{robotScene.cameraType()}</button> */}
                      </div>
                    </div>
                ...
                <AccordionItemPanel>
                  {
                    <div>
                      <div className={"Select"}>
                        ...
                        <div className={"Select-container"} style={style3}>
                ...
                <AccordionItemPanel>
                  {
                    <div className="ReloadCSV">
                      <div>
                        <FileUploader
                          label="Replace with a local animation: "
                          accept={[".csv"]}
                          vertical={false}
