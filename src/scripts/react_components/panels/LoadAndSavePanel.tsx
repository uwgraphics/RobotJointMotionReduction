        ...
        return (
            <div className="LoadAndSavePanel">
                <div className="PopUpGroup">
                    <h3><label> <b>  Load and save workspace and motion data </b>  </label></h3>
                ...
                <div className="MotionLoader">

                    <div className="LS-label"><label> <b>  Motion </b>  </label></div>

                    <div className="LoadRobot">
                        <label> <b> Step 1: Load a robot URDF/object mesh: </b>  </label>
                        {/*<FileUploader 
                    label="Upload URDF"
                    vertical={true}
                ...
                />*/}
                        ...
                        {/* <select className={"Select"} ref={this._exampleRobotInput}>
                                {this._exampleRobotOptions}
                            </select> */}
                    ...
                    <div className="LoadCSV">
                        <label> <b> Step 2: Load motion data (CSV): </b>  </label>
                        <br />
